...
class CPU {
 public:
  ...
  /*
    ...
    counter is 16 bits too.
  */

  uint16_t PC;

  // Stack pointer is 8 bit
  ...
  */
  ...
  /* 
     Buggy version of read (actual bug in 6502 that 
     we have to implement to be true to the original
  */
  
  uint16_t readWord_buggy(uint16_t address);
  ...
  */
  ...
  /*
    ...
    and some macros, but I can't think of anything 
